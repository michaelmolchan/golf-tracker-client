...
var getFormFields = __webpack_require__(4);
var roundsApi = __webpack_require__(15);
var roundsUi = __webpack_require__(16);

var onAddRound = function onAddRound(event) {
  event.preventDefault();
  var data = getFormFields(event.target);
  roundsApi.addRound(data).then(roundsUi.addRoundSuccess).catch(roundsUi.addRoundError);
};

var onGetRounds = function onGetRounds(event) {
  event.preventDefault();
  // console.log(event)
  roundsApi.getRounds().then(roundsUi.getRoundsSuccess).catch(roundsUi.getRoundsError);
};

var refreshRounds = function refreshRounds(event) {
  $('.content').html('');
  roundsApi.getRounds().then(roundsUi.getRoundsSuccess).catch(roundsUi.getRoundsError);
};
...
var onAddRoundTabClick = function onAddRoundTabClick() {
  $('#get-rounds-error').hide();
  $('#no-rounds-error').hide();
  $('.content').html('');
  $('#content-header').hide();
...
var onRemoveRound = function onRemoveRound(event) {
  event.preventDefault();
  var roundId = $(event.target).attr('data-id');
  roundsApi.removeRound(roundId).then(roundsUi.removeRoundSuccess).catch(roundsUi.removeRoundError).then(refreshRounds);
};
...
var onUpdateRound = function onUpdateRound(event) {
  ...
  var data = getFormFields(event.target);
  var roundId = $(event.target).attr('data-id');
  roundsApi.updateRound(data, roundId).then(roundsUi.updateRoundSuccess).catch(roundsUi.updateRoundError).then(refreshRounds);
};

module.exports = {
  onAddRound: onAddRound,
  onGetRounds: onGetRounds,
  onAddRoundTabClick: onAddRoundTabClick,
...
var removeRound = function removeRound(roundId) {
  return $.ajax({
    method: 'DELETE',
...
var updateRound = function updateRound(data, roundId) {
  return $.ajax({
    method: 'PATCH',
    url: config.apiUrl + 'rounds/' + roundId,
    data: data,
...
var addRoundSuccess = function addRoundSuccess(addRoundResponse) {
  $('#add-round-form')[0].reset();
  $('#successModal').modal('show');
  $('#success-message').html('Your round has been added to your profile!');
};

var addRoundError = function addRoundError(_addRoundError) {
  $('#add-round-form')[0].reset();
  $('#add-round-error').delay(100).fadeIn(100);
};

var getRoundsSuccess = function getRoundsSuccess(getRoundsResponse) {
  $('#get-rounds-error').hide();
  $('#content-header').show();
  $('.content').show();
  $('#get-rounds').hide();
  var showRoundsHtml = showRoundsTemplate({ rounds: getRoundsResponse.rounds });
...
var getRoundsError = function getRoundsError(_getRoundsError) {
  $('#get-rounds-error').delay(100).fadeIn(100);
};

var removeRoundSuccess = function removeRoundSuccess(removeRoundsSuccess) {
  $('#successModal').modal('show');
  $('#success-message').html('You successfully removed this round!');
};

var removeRoundError = function removeRoundError(removeRoundsError) {}
...
;var updateRoundSuccess = function updateRoundSuccess(updateRoundResponse) {
  $('#successModal').modal('show');
  $('#success-message').html('Your round has been updated!');
};

var updateRoundError = function updateRoundError(_updateRoundError) {
  // console.log(updateRoundError)
};

module.exports = {
  addRoundSuccess: addRoundSuccess,
  addRoundError: addRoundError,
  getRoundsSuccess: getRoundsSuccess,
  getRoundsError: getRoundsError,
  removeRoundSuccess: removeRoundSuccess,
  removeRoundError: removeRoundError,
...
module.exports = (Handlebars["default"] || Handlebars).template({"1":function(container,depth0,helpers,partials,data,blockParams) {
  ...
  return "\n  <div class=\"round-display\" id=\""
    ...
    + "</h2>\n    <form class='edit-course' data-id=\""
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.id : stack1), depth0))
    + "\">\n      <input type=\"date\" name=\"round[date]\" tabindex=\"1\" class=\"form-control\" placeholder=\""
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.date : stack1), depth0))
    + "\" required>\n      <button class=\"btn btn-info btn-style\" type=\"submit\">Update</button>\n    </form>\n    <h2><b>Course:</b> "
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.course : stack1), depth0))
    + "</h2>\n    <form class='edit-course' data-id=\""
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.id : stack1), depth0))
    + "\">\n      <input type=\"text\" name=\"round[course]\" tabindex=\"2\" class=\"form-control\" placeholder=\""
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.course : stack1), depth0))
    + "\" required>\n      <button class=\"btn btn-info btn-style\" type=\"submit\">Update</button>\n    </form>\n    <h2><b>Course Location:</b> "
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.location : stack1), depth0))
    + "</h2>\n    <form class='edit-location' data-id=\""
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.id : stack1), depth0))
    + "\">\n      <input type=\"text\" name=\"round[location]\" tabindex=\"3\" class=\"form-control\" placeholder=\""
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.location : stack1), depth0))
    + "\" required>\n      <button class=\"btn btn-info btn-style\" type=\"submit\">Update</button>\n    </form>\n    <h2><b>Course Par:</b> "
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.par : stack1), depth0))
    + "</h2>\n    <form class='edit-par' data-id=\""
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.id : stack1), depth0))
    + "\">\n      <input type=\"text\" name=\"round[par]\" tabindex=\"4\" class=\"form-control\" placeholder=\""
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.par : stack1), depth0))
    + "\" required>\n      <button class=\"btn btn-info btn-style\" type=\"submit\">Update</button>\n    </form>\n    <h2><b>Score:</b> "
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.score : stack1), depth0))
    + "</h2>\n    <form class='edit-score' data-id=\""
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.id : stack1), depth0))
    + "\">\n      <input type=\"text\" name=\"round[score]\" tabindex=\"5\" class=\"form-control\" placeholder=\""
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.score : stack1), depth0))
    + "\" required>\n      <button class=\"btn btn-info btn-style\" type=\"submit\">Update</button>\n    </form>\n    <button id=\"remove-round\" class=\"btn btn-danger btn-style\" data-id='"
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.id : stack1), depth0))
    + "'>Remove Round</button>\n    <!-- <button type=\"button\" class=\"btn btn-info\" data-toggle=\"modal\" data-target=\"#updateRoundModal\" data-id='"
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.id : stack1), depth0))
    + "'>Update Round</button> -->\n    <!-- <div class='edit-round'>\n      <h3>Edit Round</h3>\n      <form class='edit-round-form' data-id=\""
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.id : stack1), depth0))
    + "\">\n        <input name='round[id]' type=\"text\" readonly>\n        <input type=\"date\" name=\"round[date]\" tabindex=\"1\" class=\"form-control\" placeholder=\""
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.date : stack1), depth0))
    + "\">\n        <input type=\"text\" name=\"round[course]\" tabindex=\"2\" class=\"form-control\" placeholder=\""
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.course : stack1), depth0))
    + "\">\n        <input type=\"text\" name=\"round[location]\" tabindex=\"3\" class=\"form-control\" placeholder=\""
    ...
    + "\">\n        <input type=\"text\" name=\"round[score]\" tabindex=\"5\" class=\"form-control\" placeholder=\""
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.score : stack1), depth0))
    + "\">\n        <button class=\"btn btn-info\" type=\"submit\">Update</button>\n      </form>\n    </div> -->\n    <hr>\n  </div>\n\n  <!-- Update Round Modal -->\n  <!-- <div class=\"modal fade\" id=\"updateRoundModal\" tabindex=\"-1\" role=\"dialog\" aria-labelledby=\"exampleModalLabel\" aria-hidden=\"true\">\n    <div class=\"modal-dialog\" role=\"document\">\n      <div class=\"modal-content\">\n        <div class=\"modal-header\">\n          <button type=\"button\" class=\"close\" data-dismiss=\"modal\" aria-label=\"Close\">\n            <span aria-hidden=\"true\">&times;</span>\n          </button>\n          <h2 class=\"modal-title-custom\" id=\"exampleModalLabel\">Update Round</h2>\n        </div>\n        <div class=\"modal-body\">\n          <form class=\"update-round\">\n            <div id=\"update-round-error\" class=\"alert alert-danger\">\n              <strong>Unable to update round!</strong> Please try again!\n            </div>\n            <div class=\"form-group\">\n              <input type=\"date\" name=\"round[date]\" tabindex=\"1\" class=\"form-control\" placeholder=\"Date\">\n            </div>\n            <div class=\"form-group\">\n              <input type=\"text\" name=\"round[course]\" tabindex=\"2\" class=\"form-control\" placeholder=\"Golf Course\">\n            </div>\n            <div class=\"form-group\">\n              <input type=\"text\" name=\"round[location]\" tabindex=\"3\" class=\"form-control\" placeholder=\"Course Location\">\n            </div>\n            <div class=\"form-group\">\n              <input type=\"text\" name=\"round[par]\" tabindex=\"4\" class=\"form-control\" placeholder=\"Course Par\">\n            </div>\n            <div class=\"form-group\">\n              <input type=\"text\" name=\"round[score]\" tabindex=\"5\" class=\"form-control\" placeholder=\"Your Score\">\n            </div>\n            <div class=\"modal-footer\">\n              <button type=\"button\" class=\"btn btn-danger\" data-dismiss=\"modal\">Close</button>\n              <button type=\"submit\" class=\"btn btn-success\" data-id='"
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.id : stack1), depth0))
    + "'>Update Round</button>\n            </div>\n          </form>\n        </div>\n      </div>\n    </div>\n  </div> -->\n\n";
},"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data,blockParams) {
    var stack1;

  return ((stack1 = helpers.each.call(depth0 != null ? depth0 : (container.nullContext || {}),(depth0 != null ? depth0.rounds : depth0),{"name":"each","hash":{},"fn":container.program(1, data, 1, blockParams),"inverse":container.noop,"data":data,"blockParams":blockParams})) != null ? stack1 : "");
